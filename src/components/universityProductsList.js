...
function UniversityProductsList() {
    ...
    const les_domains = ["Mathématiques", "Physique", "Chimie",
    ...
    if (getQueryStringValue("categorie") !== "") {
        domainInit = getQueryStringValue("categorie");
    } else {
        domainInit = "allDomains";
    }
    let titleInit = "";
    ...
    const [url, setUrl] = useState("https://kotobima.herokuapp.com/university_productslist/" + orderBy + "?page=" + currentPage + "&city=" + city + "&domain=" + domain + "&states=" + states.string + "&languages=" + languages.string + title);
    ...
    const handleChange = (e) => {
        ...
        if (e.target.name === "domain") {
            setUrl(url.replace(domain, e.target.value));
        ...
        <a href={"\product?id=" + product.id} ><div key={idx} className="Product">
            ...
            <div className="Product_info">
                ...
                <div id={"other_infos" + idx} className="other_infos">
                    <p id={"domain" + idx} className="domain"><FontAwesomeIcon className="iconPrdct" icon={faTag} />{product.domain}</p>
            ...
            <form onSubmit={handleSubmit}>
                <div id="searchbox_upper">
                    ...
                    <div>
                        ...
                        <select name="domain" onChange={handleChange} className="searchItem" defaultValue="">
                            <option hidden value="">Domaine:</option>
                            {les_domains.map((item, idx) =>
...
export default UniversityProductsList;