...
import { faMapMarkerAlt, faBookmark, faUniversity, faTag, faClock,  faMapMarkedAlt, faBookOpen } from '@fortawesome/free-solid-svg-icons';
...
function LessonNotes() {
    ...
    const [nomFaculte, setNomFaculte] = useState("&nomFaculte=");
    ...
    const [url, setUrl] = useState("https://kotobima.herokuapp.com/lessonNotes_productslist/" + orderBy + "?page=" + currentPage + "&city=" + city + "&states=" + states.string + "&languages=" + languages.string + module + nomFaculte + title);
    ...
    const handleChange = (e) => {
        ...
        if (e.target.name === "module") {
            let newModule = e.target.value.replace(/\s+/g, '_').toLowerCase();
            setUrl(url.replace(module, "&module=" + newModule));
            setModule("&module=" + newModule);
        }
        if (e.target.name === "nomFaculte") {
            let newFaculte = e.target.value.replace(/\s+/g, '_').toLowerCase();
            setUrl(url.replace(nomFaculte, "&nomFaculte=" + newFaculte));
            setNomFaculte("&nomFaculte=" + newFaculte);
        }
        ...
        <a href={"\product?id=" + product.id} ><div key={idx} className="Product">
            ...
            <div className="Product_info">
                ...
                <div id={"other_infos" + idx} className="other_infos">
                    <p id={"product_ctg" + idx} className="product_ctg"><FontAwesomeIcon className="iconPrdct" icon={faTag} />{product.module}</p>
        ...
        <div className="searchBox">
            ...
            <form onSubmit={handleSubmit}>
                <div id="searchbox_upper">
                    ...
                    <div>
                        <FontAwesomeIcon className="inputIcon" icon={faUniversity} />
                        <input onChange={handleChange} name="nomFaculte" className="searchItem" placeholder="Nom Faculte / école..." id="firstInput" type="text" />
                    </div>
                    <div>
                        <FontAwesomeIcon className="inputIcon" icon={faBookmark} />
                        <input onChange={handleChange} name="module" className="searchItem" placeholder="Module..." id="firstInput" type="text" />
                    </div>
            ...
            <div className="typesLinks">
                ...
                <a href="/schoolProducts">Livre Scolaires</a>
